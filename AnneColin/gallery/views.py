...
def contact(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            message_html = get_template("gallery/email/contact.html").render({'context': Context(context)})
            message_txt = get_template("gallery/email/contact.txt").render({'context': Context(context)})
